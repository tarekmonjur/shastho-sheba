                ...
                <div class="col-md-6">
                    <div class="subtitle-text">
                        <div class="sub-link">
                            ...
                            <a href="{{url('manufacturers')}}">Manufacturer</a><i class="fa fa-angle-right"></i>{{$manufacturer->medicine_company_name}}
                        </div>
                        <h1>{{$manufacturer->medicine_company_name}} ({{$manufacturer->medicines->count()}}) <span>drug list</span> </h1>
                    </div>
                </div>
            </div>
        </div>
