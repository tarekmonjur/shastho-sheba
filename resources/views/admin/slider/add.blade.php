...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">Add Slider</a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <form role="form" method="post" action="{{url('sliders/add')}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group {{ $errors->has('slider_title') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" name="slider_title" value="{{ old('slider_title') }}" placeholder="Enter Slider Title...">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group {{ $errors->has('slider_url') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" name="slider_url" value="{{ old('slider_url') }}" placeholder="Enter Slider Url...">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group {{ $errors->has('slider_description') ? ' has-error' : '' }}">
                                    ...
                                    <textarea id="slider_description" class="form-control" name="slider_description" placeholder="Enter Slider Description">{{ old('slider_description') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('slider_status') ? ' has-error' : '' }}">
                                    ...
                                    <div>
                                        <input type="radio" name="slider_status" value="active" class="flat-green" checked>
                                        <strong>Active</strong>
                                        &nbsp; &nbsp;
                                        <input type="radio" name="slider_status" value="inactive" class="flat-red">
