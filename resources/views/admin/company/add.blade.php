...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">Add Medicine Company</a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <form role="form" method="post" action="{{url('companies/add')}}">
                    {{csrf_field()}}
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group {{ $errors->has('medicine_company_name') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" onkeyup="toSlug(this.value)" class="form-control" name="medicine_company_name" value="{{ old('medicine_company_name') }}" placeholder="Enter Medicine Company Name">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group {{ $errors->has('medicine_company_slug') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" id="medicine_company_slug" class="form-control" name="medicine_company_slug" value="{{ old('medicine_company_slug') }}" placeholder="Enter Medicine Company Slug">
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('medicine_company_status') ? ' has-error' : '' }}">
                                    ...
                                    <div>
                                        <input type="radio" name="medicine_company_status" value="active" class="flat-green" @if(old('medicine_company_status') == 'active') checked @endif>
                                        <strong>Active</strong>
                                        &nbsp; &nbsp;
                                        <input type="radio" name="medicine_company_status" value="inactive" class="flat-red" @if(old('medicine_company_status') == 'inactive') checked @endif>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group {{ $errors->has('medicine_company_address') ? ' has-error' : '' }}">
                                    ...
                                    <textarea class="form-control" name="medicine_company_address" placeholder="Enter interaction">{{ old('medicine_company_address') }}</textarea>
