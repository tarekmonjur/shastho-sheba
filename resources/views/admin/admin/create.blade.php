    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                <form role="form" method="post" action="{{url('admins/create')}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('mobile_no') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" name="mobile_no" value="{{ old('mobile_no') }}" placeholder="Enter mobile no">
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('gender') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="radio" class="flat-red" name="gender" value="male" @if(old('gender') == 'male') checked @endif >
                                        <label for="female">Female : </label>
                                        <input type="radio" class="flat-red" name="gender" value="female" @if(old('gender') == 'female') checked @endif>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('status') ? ' has-error' : '' }}">
                                    ...
                                    <div>
                                        <input type="radio" name="status" value="active" class="flat-green" @if(old('status') == 'active') checked @endif>
                                        <strong>Active</strong>
                                        &nbsp; &nbsp;
                                        <input type="radio" name="status" value="inactive" class="flat-red" @if(old('status') == 'inactive') checked @endif>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="address" placeholder="Enter full address">{{ old('address') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
